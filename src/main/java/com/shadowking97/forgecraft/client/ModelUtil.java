    ...
    public static class UnbakedQuad {
        ...
        public BakedQuad bake(float scale) {
            return new BakedQuad(Ints.concat(
                    vertexToInts(p1.xCoord*scale, p1.yCoord*scale, p1.zCoord*scale, u1, v1, sprite),
                    vertexToInts(p2.xCoord*scale, p2.yCoord*scale, p2.zCoord*scale, u2, v2, sprite),
                    vertexToInts(p3.xCoord*scale, p3.yCoord*scale, p3.zCoord*scale, u3, v3, sprite),
                    vertexToInts(p4.xCoord*scale, p4.yCoord*scale, p4.zCoord*scale, u4, v4, sprite)
