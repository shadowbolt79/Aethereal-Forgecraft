...
public class Anvil extends BlockContainerBase<TileAnvil> implements IHammerable {
    ...
    public void useHammer(ItemStack hammer, EntityPlayer player, BlockPos pos) {
        ...
        {
            TileAnvil tileAnvil = getTileEntity(player.worldObj,pos);
            ...
            {
                ((IHammerableItem) stack.getItem()).onUseHammer(stack,pos,player.worldObj);
            }
    ...
    public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer, ItemStack stack) {
        ...
        {
            if(!((EntityPlayer) placer).isCreative())stack.stackSize--;
        }
        else
            stack.stackSize--;
        return state;
