...
public class TileAnvil extends TileEntity {
    public ItemStackHandler inventory = new ItemStackHandler(1) {
        ...
        protected void onContentsChanged(int slot)
        {
            ...
            {
                Forgecraft.network.sendToAllAround(new PacketUpdateAnvil(TileAnvil.this), new NetworkRegistry.TargetPoint(worldObj.provider.getDimension(),pos.getX(), pos.getY(), pos.getZ(), 64));
